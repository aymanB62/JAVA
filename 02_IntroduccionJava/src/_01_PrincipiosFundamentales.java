...
//Son muy útiles para nostros y para los futuros desarrolladores que lean
//nuestro código.
...
//ayude a completarlo.
	public static void main(String[] args) {
		...
		// Es muy importante que seáis ordenados en el código FUNDAMENTAL, debeis
		...
		// Por ejempo, si no ponemos ";" al final de una sentencia, o escribimos mal el nombre
		// de una sentencia... Hay muchas maneras de cometer estor errores.
		// Poniendo el cursor del ratón sobre el error podemos intentar sacar información del mismo
